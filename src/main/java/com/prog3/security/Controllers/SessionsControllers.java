...
//public int getTwoFactorErrors(@PathVariable String userId) {
//    List<Session> userSessions = this.theSessionRepository.getSessionByUser(userId);
//    Verificar si hay sesiones disponibles
//    if (userSessions == null || userSessions.isEmpty()) {
//        return 0; // Si no hay sesiones, retornar 0
//    }
//    Tomar la primera sesión de la lista
//    Session firstSession = userSessions.get(0);
//    Retornar el contador de errores de la primera sesión
//    return firstSession.getTimesErrorValidationCode();
//    }