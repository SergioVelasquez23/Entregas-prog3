...
import { SpecialityOperatorService } from 'src/app/services/speciality-operatorService/speciality-operator.service'; // Importa el servicio SpecialityOperatorService
