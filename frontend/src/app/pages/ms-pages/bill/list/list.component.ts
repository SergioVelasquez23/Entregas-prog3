...
import { Factura } from 'src/app/models/bill.model'; // Cambié el modelo a Factura
import { FacturaService } from 'src/app/services/billService/bill.service'; // Cambié el servicio a FacturaService
