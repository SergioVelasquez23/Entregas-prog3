...
import { Poliza } from 'src/app/models/policy.model'; // Importa el modelo Policy
import { PolizaService } from 'src/app/services/policyService/policy.service'; // Importa el servicio PolicyService
